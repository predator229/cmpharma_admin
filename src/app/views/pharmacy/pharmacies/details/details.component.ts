...
import {Select2AjaxComponent} from "../../../select2-ajax/select2-ajax.component";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SharedModule, RouterModule, ReactiveFormsModule, MapSelectorComponent, Select2AjaxComponent],
...
export class PharmacyDetailComponentPharmacie implements OnInit, OnDestroy {
  @Input() userDetail!: UserDetails;pharmacy: PharmacyClass | null = null;
