...
export class PharmacyDetailComponentPharmacie implements OnInit, OnDestroy {
  ...
  constructor( private location: Loc, private modalService: NgbModal,  private auth: AuthService,  private router: Router,  private route: ActivatedRoute,  private apiService: ApiService,  private loadingService: LoadingService,  private fb: FormBuilder,  private sanitizer: DomSanitizer) {
